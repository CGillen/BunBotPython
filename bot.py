...
async def play_stream(interaction, url):
  ...
  music_stream = discord.FFmpegPCMAudio(source=url, options="-rtbufsize 4092 -filter:a loudnorm=I=-30:LRA=7:TP=-3 -reconnect 1 -reconnect_streamed 1 -reconnect_delay_max 5 -tls_verify 0")
